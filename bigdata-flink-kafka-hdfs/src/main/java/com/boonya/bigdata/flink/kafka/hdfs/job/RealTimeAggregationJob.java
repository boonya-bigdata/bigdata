...
public class RealTimeAggregationJob {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RealTimeAggregationJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String groupId = getParam(args, "kafka.group.id", "flink-consumer-group");
        ...
        DataStream<String> aggregatedStream = eventStream
                ...
                .process(new AmountAggregator())
                .name("Amount Aggregator")
                .uid("aggregator");

        aggregatedStream.print("实时聚合结果");

        String hdfsPath = getParam(args, "hdfs.path", "hdfs://localhost:9000/user/flink/events");
        ...
        LOG.info("启动Flink任务: Kafka={}, Topic={}, HDFS={}", bootstrapServers, topic, hdfsPath);
    ...
    private static class AmountAggregator extends org.apache.flink.streaming.api.functions.KeyedProcessFunction<Integer, UserEvent, String> {
